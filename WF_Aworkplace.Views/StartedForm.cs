...
namespace WF_Aworkplace.View
{
    public partial class StartedForm : Form
    {
        ...
        {
            outputLiteratureForReader or = new outputLiteratureForReader();
            or.ShowDialog();
        }

        private void outputLiterature_Click(object sender, EventArgs e)
        {
            InputLiteratureView il = new InputLiteratureView();
            il.ShowDialog();
        }
    }
}
